  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium font-body ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground text-base px-8 py-6 rounded-none hover:bg-primary/90 shadow-[0_4px_30px_hsl(38_90%_55%_/_0.3)] hover:shadow-[0_8px_50px_hsl(38_90%_55%_/_0.4)] hover:-translate-y-1 transition-all duration-500",
        "hero-outline": "border-2 border-foreground/30 bg-transparent text-foreground text-base px-8 py-6 rounded-none hover:border-primary hover:text-primary transition-all duration-500",
      },
      size: {
